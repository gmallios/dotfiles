...
DOCKER_LOGS_DIR=~/docker_logs
NEXUS_HOST=10.240.151.23
NEXUS_PORT=7290
if [ -z "$DOCKER_RUNNING" ]; then
    nohup sudo -b dockerd  --insecure-registry=$NEXUS_HOST:$NEXUS_PORT< /dev/null > $DOCKER_LOGS_DIR/dockerd.log 2>&1
fi
